								...
								<fieldset>
									...
									<div class="form-group{{ Alert::onForm('slug', ' has-error') }}">
										...
										<span class="help-block"></span>
                                                                        ...
                                                                        <!-- BC --->
                                                                        {{-- Site --}}
									<div class="form-group{{ Alert::onForm('site', ' has-error') }}">

										<label class="control-label" for="menu-site">
											<i class="fa fa-info-circle" data-toggle="popover" data-content="{{{ trans('platform/menus::model.general.site_help') }}}"></i>
											{{ trans('platform/menus::model.general.site') }}
										</label>

										<input type="text" class="form-control" name="menu-site" id="menu-site" value="{{{ $menu->exists ? $menu->site : null }}}" placeholder="{{{ trans('platform/menus::model.general.site') }}}" required data-parsley-trigger="change">
